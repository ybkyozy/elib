...
static SQInteger __stdcall _string_format(HSQUIRRELVM v)
{
    SQChar *dest = NULL;
    SQInteger length = 0;
...
static SQInteger __stdcall _string_strip(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _string_lstrip(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _string_rstrip(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _string_split(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _string_escape(HSQUIRRELVM v)
{
    const SQChar *str;
    SQChar *dest,*resstr;
    SQInteger size;
...
static SQInteger __stdcall _string_startswith(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _string_endswith(HSQUIRRELVM v)
{
    const SQChar *str,*cmp;
    sq_getstring(v,2,&str);
    sq_getstring(v,3,&cmp);
...
static SQInteger __stdcall _rexobj_releasehook(SQUserPointer p, SQInteger SQ_UNUSED_ARG(size))
{
    SQRex *self = ((SQRex *)p);
    sqstd_rex_free(self);
    return 1;
...
static SQInteger __stdcall _regexp_match(HSQUIRRELVM v)
{
    SETUP_REX(v);
    const SQChar *str;
    sq_getstring(v,2,&str);
...
static SQInteger __stdcall _regexp_search(HSQUIRRELVM v)
{
    SETUP_REX(v);
...
static SQInteger __stdcall _regexp_capture(HSQUIRRELVM v)
{
    SETUP_REX(v);
    const SQChar *str,*begin,*end;
    SQInteger start = 0;
...
static SQInteger __stdcall _regexp_subexpcount(HSQUIRRELVM v)
{
    SETUP_REX(v);
...
static SQInteger __stdcall _regexp_constructor(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _regexp__typeof(HSQUIRRELVM v)
{
