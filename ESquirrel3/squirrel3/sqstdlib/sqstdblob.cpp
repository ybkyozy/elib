...
static SQInteger __stdcall _blob_resize(HSQUIRRELVM v)
{
    SETUP_BLOB(v);
    SQInteger size;
...
static SQInteger __stdcall _blob_swap4(HSQUIRRELVM v)
{
    SETUP_BLOB(v);
...
static SQInteger __stdcall _blob_swap2(HSQUIRRELVM v)
{
    SETUP_BLOB(v);
...
static SQInteger __stdcall _blob__set(HSQUIRRELVM v)
{
    SETUP_BLOB(v);
    SQInteger idx,val;
...
static SQInteger __stdcall _blob__get(HSQUIRRELVM v)
{
    SETUP_BLOB(v);
    SQInteger idx;
    sq_getinteger(v,2,&idx);
...
static SQInteger __stdcall _blob__nexti(HSQUIRRELVM v)
{
    SETUP_BLOB(v);
...
static SQInteger __stdcall _blob__typeof(HSQUIRRELVM v)
{
    sq_pushstring(v,_SC("blob"),-1);
    return 1;
}

static SQInteger __stdcall _blob_releasehook(SQUserPointer p, SQInteger SQ_UNUSED_ARG(size))
{
...
static SQInteger __stdcall _blob_constructor(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _blob__cloned(HSQUIRRELVM v)
{
    SQBlob *other = NULL;
    {
...
static SQInteger __stdcall _g_blob_casti2f(HSQUIRRELVM v)
{
    SQInteger i;
    sq_getinteger(v,2,&i);
...
static SQInteger __stdcall _g_blob_castf2i(HSQUIRRELVM v)
{
    SQFloat f;
    sq_getfloat(v,2,&f);
...
static SQInteger __stdcall _g_blob_swap2(HSQUIRRELVM v)
{
    SQInteger i;
    sq_getinteger(v,2,&i);
    short s=(short)i;
...
static SQInteger __stdcall _g_blob_swap4(HSQUIRRELVM v)
{
    SQInteger i;
    sq_getinteger(v,2,&i);
...
static SQInteger __stdcall _g_blob_swapfloat(HSQUIRRELVM v)
{
    SQFloat f;
    sq_getfloat(v,2,&f);
