...
static SQInteger __stdcall base_dummy(HSQUIRRELVM SQ_UNUSED_ARG(v))
{
    return 0;
}

#ifndef NO_GARBAGE_COLLECTOR
static SQInteger __stdcall base_collectgarbage(HSQUIRRELVM v)
{
    sq_pushinteger(v, sq_collectgarbage(v));
    return 1;
}
static SQInteger __stdcall base_resurectureachable(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_getroottable(HSQUIRRELVM v)
{
    v->Push(v->_roottable);
    return 1;
}

static SQInteger __stdcall base_getconsttable(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_setroottable(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_setconsttable(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_seterrorhandler(HSQUIRRELVM v)
{
    sq_seterrorhandler(v);
    return 0;
}

static SQInteger __stdcall base_setdebughook(HSQUIRRELVM v)
{
    sq_setdebughook(v);
    return 0;
}

static SQInteger __stdcall base_enabledebuginfo(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_getstackinfos(HSQUIRRELVM v)
{
    SQInteger level;
...
static SQInteger __stdcall base_assert(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_print(HSQUIRRELVM v)
{
    const SQChar *str;
...
static SQInteger __stdcall base_error(HSQUIRRELVM v)
{
    const SQChar *str;
    if(SQ_SUCCEEDED(sq_tostring(v,2)))
    {
...
static SQInteger __stdcall base_compilestring(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_newthread(HSQUIRRELVM v)
{
...
static SQInteger __stdcall base_suspend(HSQUIRRELVM v)
{
    return sq_suspendvm(v);
}

static SQInteger __stdcall base_array(HSQUIRRELVM v)
{
    SQArray *a;
...
static SQInteger __stdcall base_type(HSQUIRRELVM v)
{
    SQObjectPtr &o = stack_get(v,2);
...
static SQInteger __stdcall base_callee(HSQUIRRELVM v)
{
...
static SQInteger __stdcall default_delegate_len(HSQUIRRELVM v)
{
    v->Push(SQInteger(sq_getsize(v,1)));
    return 1;
}

static SQInteger __stdcall default_delegate_tofloat(HSQUIRRELVM v)
{
...
static SQInteger __stdcall default_delegate_tointeger(HSQUIRRELVM v)
{
    SQObjectPtr &o=stack_get(v,1);
    SQInteger base = 10;
    if(sq_gettop(v) > 1) {
...
static SQInteger __stdcall default_delegate_tostring(HSQUIRRELVM v)
{
...
static SQInteger __stdcall obj_delegate_weakref(HSQUIRRELVM v)
{
    sq_weakref(v,1);
    return 1;
}

static SQInteger __stdcall obj_clear(HSQUIRRELVM v)
{
    return sq_clear(v,-1);
}


static SQInteger __stdcall number_delegate_tochar(HSQUIRRELVM v)
{
...
static SQInteger __stdcall table_rawdelete(HSQUIRRELVM v)
{
...
static SQInteger __stdcall container_rawexists(HSQUIRRELVM v)
{
...
static SQInteger __stdcall container_rawset(HSQUIRRELVM v)
{
    return sq_rawset(v,-3);
}


static SQInteger __stdcall container_rawget(HSQUIRRELVM v)
{
    return SQ_SUCCEEDED(sq_rawget(v,-2))?1:SQ_ERROR;
}

static SQInteger __stdcall table_setdelegate(HSQUIRRELVM v)
{
...
static SQInteger __stdcall table_getdelegate(HSQUIRRELVM v)
{
...
static SQInteger __stdcall array_append(HSQUIRRELVM v)
{
    return sq_arrayappend(v,-2);
}

static SQInteger __stdcall array_extend(HSQUIRRELVM v)
{
    _array(stack_get(v,1))->Extend(_array(stack_get(v,2)));
    return 0;
}

static SQInteger __stdcall array_reverse(HSQUIRRELVM v)
{
    return sq_arrayreverse(v,-1);
}

static SQInteger __stdcall array_pop(HSQUIRRELVM v)
{
    return SQ_SUCCEEDED(sq_arraypop(v,1,SQTrue))?1:SQ_ERROR;
}

static SQInteger __stdcall array_top(HSQUIRRELVM v)
{
    SQObject &o=stack_get(v,1);
    if(_array(o)->Size()>0){
        v->Push(_array(o)->Top());
...
static SQInteger __stdcall array_insert(HSQUIRRELVM v)
{
    SQObject &o=stack_get(v,1);
...
static SQInteger __stdcall array_remove(HSQUIRRELVM v)
{
    SQObject &o = stack_get(v, 1);
    SQObject &idx = stack_get(v, 2);
...
static SQInteger __stdcall array_resize(HSQUIRRELVM v)
{
    SQObject &o = stack_get(v, 1);
...
static SQInteger __stdcall array_map(HSQUIRRELVM v)
{
    SQObject &o = stack_get(v,1);
...
static SQInteger __stdcall array_apply(HSQUIRRELVM v)
{
    SQObject &o = stack_get(v,1);
...
static SQInteger __stdcall array_reduce(HSQUIRRELVM v)
{
    SQObject &o = stack_get(v,1);
    SQArray *a = _array(o);
...
static SQInteger __stdcall array_filter(HSQUIRRELVM v)
{
    SQObject &o = stack_get(v,1);
    SQArray *a = _array(o);
...
static SQInteger __stdcall array_find(HSQUIRRELVM v)
{
    SQObject &o = stack_get(v,1);
...
static SQInteger __stdcall array_sort(HSQUIRRELVM v)
{
    SQInteger func = -1;
    SQObjectPtr &o = stack_get(v,1);
    if(_array(o)->Size() > 1) {
...
static SQInteger __stdcall array_slice(HSQUIRRELVM v)
{
    SQInteger sidx,eidx;
    SQObjectPtr o;
...
static SQInteger __stdcall string_slice(HSQUIRRELVM v)
{
    SQInteger sidx,eidx;
    SQObjectPtr o;
...
static SQInteger __stdcall string_find(HSQUIRRELVM v)
{
...
#define STRING_TOFUNCZ(func) static SQInteger __stdcall  string_##func(HSQUIRRELVM v) \
{\
    SQInteger sidx,eidx; \
    SQObjectPtr str; \
...
static SQInteger __stdcall closure_pcall(HSQUIRRELVM v)
{
    return SQ_SUCCEEDED(sq_call(v,sq_gettop(v)-1,SQTrue,SQFalse))?1:SQ_ERROR;
}

static SQInteger __stdcall closure_call(HSQUIRRELVM v)
{
...
static SQInteger __stdcall closure_acall(HSQUIRRELVM v)
{
    return _closure_acall(v,SQTrue);
}

static SQInteger __stdcall closure_pacall(HSQUIRRELVM v)
{
    return _closure_acall(v,SQFalse);
}

static SQInteger __stdcall closure_bindenv(HSQUIRRELVM v)
{
...
static SQInteger __stdcall closure_getroot(HSQUIRRELVM v)
{
...
static SQInteger __stdcall closure_setroot(HSQUIRRELVM v)
{
...
static SQInteger __stdcall closure_getinfos(HSQUIRRELVM v) {
    SQObject o = stack_get(v,1);
...
static SQInteger __stdcall generator_getstatus(HSQUIRRELVM v)
{
    SQObject &o=stack_get(v,1);
...
static SQInteger __stdcall thread_call(HSQUIRRELVM v)
{
    SQObjectPtr o = stack_get(v,1);
    if(type(o) == OT_THREAD) {
...
static SQInteger __stdcall thread_wakeup(HSQUIRRELVM v)
{
    SQObjectPtr o = stack_get(v,1);
    if(type(o) == OT_THREAD) {
...
static SQInteger __stdcall thread_wakeupthrow(HSQUIRRELVM v)
{
    SQObjectPtr o = stack_get(v,1);
    if(type(o) == OT_THREAD) {
        SQVM *thread = _thread(o);
...
static SQInteger __stdcall thread_getstatus(HSQUIRRELVM v)
{
    SQObjectPtr &o = stack_get(v,1);
...
static SQInteger __stdcall thread_getstackinfos(HSQUIRRELVM v)
{
    SQObjectPtr o = stack_get(v,1);
    if(type(o) == OT_THREAD) {
        SQVM *thread = _thread(o);
...
static SQInteger __stdcall class_getattributes(HSQUIRRELVM v)
{
    return SQ_SUCCEEDED(sq_getattributes(v,-2))?1:SQ_ERROR;
}

static SQInteger __stdcall class_setattributes(HSQUIRRELVM v)
{
    return SQ_SUCCEEDED(sq_setattributes(v,-3))?1:SQ_ERROR;
}

static SQInteger __stdcall class_instance(HSQUIRRELVM v)
{
    return SQ_SUCCEEDED(sq_createinstance(v,-1))?1:SQ_ERROR;
}

static SQInteger __stdcall class_getbase(HSQUIRRELVM v)
{
    return SQ_SUCCEEDED(sq_getbase(v,-1))?1:SQ_ERROR;
}

static SQInteger __stdcall class_newmember(HSQUIRRELVM v)
{
    SQInteger top = sq_gettop(v);
...
static SQInteger __stdcall class_rawnewmember(HSQUIRRELVM v)
{
    SQInteger top = sq_gettop(v);
    SQBool bstatic = SQFalse;
    if(top == 5)
...
static SQInteger __stdcall instance_getclass(HSQUIRRELVM v)
{
...
static SQInteger __stdcall weakref_ref(HSQUIRRELVM v)
{
