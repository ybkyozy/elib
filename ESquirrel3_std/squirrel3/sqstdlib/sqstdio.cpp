...
static SQInteger __stdcall _file__typeof(HSQUIRRELVM v)
{
    sq_pushstring(v,_SC("file"),-1);
    return 1;
}

static SQInteger __stdcall _file_releasehook(SQUserPointer p, SQInteger SQ_UNUSED_ARG(size))
{
...
static SQInteger __stdcall _file_constructor(HSQUIRRELVM v)
{
...
static SQInteger __stdcall _file_close(HSQUIRRELVM v)
{
    SQFile *self = NULL;
...
static SQInteger __stdcall _io_file_lexfeed_PLAIN(SQUserPointer iobuf)
{
...
#ifdef SQUNICODE
static SQInteger __stdcall _io_file_lexfeed_UTF8(SQUserPointer iobuf)
{
    IOBuffer *iobuffer = (IOBuffer *)iobuf;
#define READ(iobuf) \
...
static SQInteger __stdcall _io_file_lexfeed_UCS2_LE(SQUserPointer iobuf)
{
    SQInteger ret;
    IOBuffer *iobuffer = (IOBuffer *)iobuf;
...
static SQInteger __stdcall _io_file_lexfeed_UCS2_BE(SQUserPointer iobuf)
{
    SQInteger c;
    IOBuffer *iobuffer = (IOBuffer *)iobuf;
...
SQInteger __stdcall file_read(SQUserPointer file,SQUserPointer buf,SQInteger size)
{
    SQInteger ret;
...
SQInteger __stdcall file_write(SQUserPointer file,SQUserPointer p,SQInteger size)
{
...
SQInteger __stdcall _g_io_loadfile(HSQUIRRELVM v)
{
...
SQInteger __stdcall _g_io_writeclosuretofile(HSQUIRRELVM v)
{
    const SQChar *filename;
    sq_getstring(v,2,&filename);
...
SQInteger __stdcall _g_io_dofile(HSQUIRRELVM v)
{
    const SQChar *filename;
    SQBool printerror = SQFalse;
    sq_getstring(v,2,&filename);
