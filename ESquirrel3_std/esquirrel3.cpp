...
LIB_CONST_INFO s_ConstInfo[] =
{
	...
	{ _WT("松鼠库文件移动_首部"), _WT("SEEK_SET"), NULL, LVL_SIMPLE, CT_NUM, NULL, 0 },
	{ _WT("松鼠库文件移动_当前"), _WT("SEEK_CUR"), NULL, LVL_SIMPLE, CT_NUM, NULL, 1 },
	{ _WT("松鼠库文件移动_尾部"), _WT("SEEK_END"), NULL, LVL_SIMPLE, CT_NUM, NULL, 2 },
};
...
ARG_INFO s_arg_sqstd_fopen[] =
{
	{ _WT("文件名"), _WT("path"),0,0, SDT_TEXT, 0, NULL },
	{ _WT("模式"), _WT("参考C语言的 fopen"),0,0, SDT_TEXT, 0, NULL },
};
ARG_INFO s_arg_sqstd_fread[] =
{
	{ _WT("缓冲区指针"), _WT("buffer"),0,0, SDT_INT, 0, NULL },
	{ _WT("大小"), _WT("每次读取字节数"),0,0, SDT_INT, 0, NULL },
	{ _WT("总数"), _WT("读取次数"),0,0, SDT_INT, 0, NULL },
	{ _WT("文件句柄"), _WT("由 松鼠库_文件打开() 返回"),0,0, SDT_INT, 0, NULL },
};
ARG_INFO s_arg_sqstd_fwrite[] =
{
	{ _WT("数据指针"), _WT("data"),0,0, SDT_INT, 0, NULL },
	{ _WT("大小"), _WT("每次写入字节数"),0,0, SDT_INT, 0, NULL },
	{ _WT("总数"), _WT("写入次数"),0,0, SDT_INT, 0, NULL },
	{ _WT("文件句柄"), _WT("由 松鼠库_文件打开() 返回"),0,0, SDT_INT, 0, NULL },
};
ARG_INFO s_arg_sqstd_fseek[] =
{
	{ _WT("文件句柄"), _WT("由 松鼠库_文件打开() 返回"),0,0, SDT_INT, 0, NULL },
	{ _WT("偏移量"), _WT("移动的偏移量，基于'位置'"),0,0, SDT_INT, 0, NULL },
	{ _WT("位置"), _WT("松鼠库文件移动_ 开头常量"),0,0, SDT_INT, 0, NULL },
};
ARG_INFO s_arg_sqstd_onlyf[] =
{
	{ _WT("文件句柄"), _WT("由 松鼠库_文件打开() 返回"),0,0, SDT_INT, 0, NULL },
};
ARG_INFO s_arg_sqstd_createfile[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("文件句柄"), _WT("由 松鼠库_文件打开() 返回"),0,0, SDT_INT, 0, NULL },
	{ _WT("手动关闭"), _WT("如果不为真，则在脚本内文件对象销毁时，自动关闭文件"),0,0, SDT_BOOL, 0, NULL },
};
ARG_INFO s_arg_sqstd_getfile[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("栈索引"), _WT("-1表示栈顶，1表示栈底"),0,0, SDT_INT, 0, NULL },
	{ _WT("返回文件句柄"), _WT("传递变量，保存文件句柄"),0,0, SDT_INT, 0, AS_RECEIVE_VAR },
};

ARG_INFO s_arg_sqstd_loadfile[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("脚本文件名"), _WT("要加载的脚本路径"),0,0, SDT_TEXT, 0, NULL },
	{ _WT("处理错误"), _WT("如果为真，则在编译错误时触发编译错误处理回调"),0,0, SDT_BOOL, 1, AS_HAS_DEFAULT_VALUE },
};

ARG_INFO s_arg_sqstd_dofile[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("脚本文件名"), _WT("要加载的脚本路径"),0,0, SDT_TEXT, 0, NULL },
	{ _WT("有返回值"), _WT("如果为真，则该函数将在栈中压入已执行脚本的返回值。"),0,0, SDT_BOOL, 0, AS_HAS_DEFAULT_VALUE },
	{ _WT("处理错误"), _WT("如果为真，则在编译错误时触发编译错误处理回调"),0,0, SDT_BOOL, 1, AS_HAS_DEFAULT_VALUE },
};
ARG_INFO s_arg_sqstd_writeclosuretofile[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("文件名"), _WT("保存闭包的文件路径"),0,0, SDT_TEXT, 0, NULL },
};
ARG_INFO s_arg_sqstd_createblob[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("大小"), _WT("字节为单位"),0,0, SDT_INT, 0, NULL },
};
ARG_INFO s_arg_sqstd_getblob[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("栈索引"), _WT("-1表示栈顶，1表示栈底"),0,0, SDT_INT, 0, NULL },
	{ _WT("返回字节集指针"), _WT("传递变量，保存字节集指针"),0,0, SDT_INT, 0, AS_RECEIVE_VAR },
};

ARG_INFO s_arg_sqstd_rex_compile[] =
{
	{ _WT("表达式文本"), _WT("pattern"),0,0, SDT_TEXT, 0, NULL },
	{ _WT("错误"), _WT("发生错误的文本"),0,0, SDT_TEXT, 0, AS_RECEIVE_VAR | AS_DEFAULT_VALUE_IS_EMPTY },
};
ARG_INFO s_arg_sqstd_rex[] =
{
	{ _WT("正则表达式句柄"), _WT("由 松鼠库_正则编译（） 返回"),0,0, SDT_INT, 0, NULL },
};
ARG_INFO s_arg_sqstd_rex_match[] =
{
	{ _WT("正则表达式句柄"), _WT("由 松鼠库_正则编译（） 返回"),0,0, SDT_INT, 0, NULL },
	{ _WT("要匹配的文本"), _WT(""),0,0, SDT_TEXT, 0, NULL },
};
ARG_INFO s_arg_sqstd_rex_search[] =
{
	{ _WT("正则表达式句柄"), _WT("由 松鼠库_正则编译（） 返回"),0,0, SDT_INT, 0, NULL },
	{ _WT("要搜索的文本"), _WT(""),0,0, SDT_TEXT, 0, NULL },
	{ _WT("起始搜索位置"), _WT("位置从0开始"),0,0, SDT_INT, 0, NULL },
	{ _WT("返回起始位置"), _WT("位置从0开始"),0,0, SDT_INT, 0, AS_RECEIVE_VAR },
	{ _WT("返回长度"), _WT("返回匹配的长度"),0,0, SDT_INT, 0, AS_RECEIVE_VAR },
};
ARG_INFO s_arg_sqstd_rex_searchrange[] =
{
	{ _WT("正则表达式句柄"), _WT("由 松鼠库_正则编译（） 返回"),0,0, SDT_INT, 0, NULL },
	{ _WT("要搜索的文本"), _WT(""),0,0, SDT_TEXT, 0, NULL },
	{ _WT("起始搜索位置"), _WT("位置从0开始"),0,0, SDT_INT, 0, NULL },
	{ _WT("搜索长度"), _WT("要搜索的长度"),0,0, SDT_INT, 0, NULL },
	{ _WT("返回起始位置"), _WT("位置从0开始"),0,0, SDT_INT, 0, AS_RECEIVE_VAR },
	{ _WT("返回长度"), _WT("返回匹配的长度"),0,0, SDT_INT, 0, AS_RECEIVE_VAR },
};
ARG_INFO s_arg_sqstd_rex_getsubexp[] =
{
	{ _WT("正则表达式句柄"), _WT("由 松鼠库_正则编译（） 返回"),0,0, SDT_INT, 0, NULL },
	{ _WT("子表达式索引"), _WT(""),0,0, SDT_INT, 0, NULL },
	{ _WT("返回表达式文本"), _WT(""),0,0, SDT_TEXT, 0, AS_RECEIVE_VAR },
};
ARG_INFO s_arg_sqstd_format[] =
{
	{ _WT("虚拟机句柄"), _WT("HSQUIRRELVM"),0,0, SDT_INT, 0, NULL },
	{ _WT("栈索引"), _WT("格式化字符串在栈中的索引"),0,0, SDT_INT, 0, NULL },
	{ _WT("返回字符串"), _WT("只能提供变量"),0,0, SDT_TEXT, 0, AS_RECEIVE_VAR },
};
...
static CMD_INFO s_CmdInfo[] =
{
	...
	{
		/*ccname*/	_WT("松鼠库_文件打开"),
		/*egname*/	_WT("sqstd_fopen"),
		/*explain*/	_WT("打开一个文件，返回文件句柄"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_fopen) / sizeof(s_arg_sqstd_fopen[0]),
		/*arg lp*/	s_arg_sqstd_fopen,
	},
	{
		/*ccname*/	_WT("松鼠库_文件读"),
		/*egname*/	_WT("sqstd_fread"),
		/*explain*/	_WT("读取文件到一个缓冲区，返回读取数量"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_fread) / sizeof(s_arg_sqstd_fread[0]),
		/*arg lp*/	s_arg_sqstd_fread,
	},
	{
		/*ccname*/	_WT("松鼠库_文件写"),
		/*egname*/	_WT("sqstd_fwrite"),
		/*explain*/	_WT("写入数据到文件，返回写入数量"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_fwrite) / sizeof(s_arg_sqstd_fwrite[0]),
		/*arg lp*/	s_arg_sqstd_fwrite,
	},
	{
		/*ccname*/	_WT("松鼠库_文件移动读写位置"),
		/*egname*/	_WT("sqstd_fseek"),
		/*explain*/	_WT("移动读写位置，成功返回0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_fseek) / sizeof(s_arg_sqstd_fseek[0]),
		/*arg lp*/	s_arg_sqstd_fseek,
	},
	{
		/*ccname*/	_WT("松鼠库_文件取当前读写位置"),
		/*egname*/	_WT("sqstd_ftell"),
		/*explain*/	_WT("返回当前读写位置"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_onlyf) / sizeof(s_arg_sqstd_onlyf[0]),
		/*arg lp*/	s_arg_sqstd_onlyf,
	},
	{
		/*ccname*/	_WT("松鼠库_文件刷新"),
		/*egname*/	_WT("sqstd_fflush"),
		/*explain*/	_WT("刷新输出缓冲区，成功返回0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_文件关闭"),
		/*egname*/	_WT("sqstd_fclose"),
		/*explain*/	_WT("关闭打开的文件，成功返回0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_文件是否尾"),
		/*egname*/	_WT("sqstd_feof"),
		/*explain*/	_WT("如果到达文件尾部，返回真"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_BOOL,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_创建文件"),
		/*egname*/	_WT("sqstd_createfile"),
		/*explain*/	_WT("创建一个文件对象，绑定到通过参数传递的文件句柄，并将其压入到栈中，成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_createfile) / sizeof(s_arg_sqstd_createfile[0]),
		/*arg lp*/	s_arg_sqstd_createfile,
	},
	{
		/*ccname*/	_WT("松鼠库_取文件"),
		/*egname*/	_WT("sqstd_getfile"),
		/*explain*/	_WT("从'栈索引'位置指定的文件对象中，获取文件句柄，成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_getfile) / sizeof(s_arg_sqstd_getfile[0]),
		/*arg lp*/	s_arg_sqstd_getfile,
	},
	{
		/*ccname*/	_WT("松鼠库_载入文件"),
		/*egname*/	_WT("sqstd_loadfile"),
		/*explain*/	_WT("编译一个松鼠脚本或加载预编译的脚本，将其作为闭包压入栈中，成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_loadfile) / sizeof(s_arg_sqstd_loadfile[0]),
		/*arg lp*/	s_arg_sqstd_loadfile,
	},
	{
		/*ccname*/	_WT("松鼠库_执行文件"),
		/*egname*/	_WT("sqstd_dofile"),
		/*explain*/	_WT("编译松鼠脚本或加载预编译的脚本并执行它。成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_dofile) / sizeof(s_arg_sqstd_dofile[0]),
		/*arg lp*/	s_arg_sqstd_dofile,
	},
	{
		/*ccname*/	_WT("松鼠库_写闭包到文件"),
		/*egname*/	_WT("sqstd_writeclosuretofile"),
		/*explain*/	_WT("序列化栈顶位置的闭包，作为预编译的字节码写出文件。 如果已存在具有相同名称的文件，则将覆盖该文件。成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_writeclosuretofile) / sizeof(s_arg_sqstd_writeclosuretofile[0]),
		/*arg lp*/	s_arg_sqstd_writeclosuretofile,
	},
	{
		/*ccname*/	_WT("松鼠库_注册IO库"),
		/*egname*/	_WT("sqstd_register_iolib"),
		/*explain*/	_WT("注册初始化IO库，注册之前压入一个表，用于注册全局库函数，具体哪些函数见文档。成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_置错误处理"),
		/*egname*/	_WT("sqstd_seterrorhandlers"),
		/*explain*/	_WT("初始化编译器和运行时错误处理程序，处理程序使用通过（松鼠_置打印回调函数）设置的函数来输出错误。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		_SDT_NULL,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_打印调用栈"),
		/*egname*/	_WT("sqstd_printcallstack"),
		/*explain*/	_WT("打印调用栈和栈内容，该函数通过（松鼠_置打印回调函数）设置的函数来输出stack dump。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		_SDT_NULL,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_创建二进制"),
		/*egname*/	_WT("sqstd_createblob"),
		/*explain*/	_WT("创建一个二进制blob，返回其指针。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_createblob) / sizeof(s_arg_sqstd_createblob[0]),
		/*arg lp*/	s_arg_sqstd_createblob,
	},
	{
		/*ccname*/	_WT("松鼠库_取二进制"),
		/*egname*/	_WT("sqstd_getblob"),
		/*explain*/	_WT("从'栈索引'位置获取二进制blob指针，成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_getblob) / sizeof(s_arg_sqstd_getblob[0]),
		/*arg lp*/	s_arg_sqstd_getblob,
	},
	{
		/*ccname*/	_WT("松鼠库_取二进制长度"),
		/*egname*/	_WT("sqstd_getblobsize"),
		/*explain*/	_WT("返回'栈索引'位置处二进制blob的大小"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_注册二进制库"),
		/*egname*/	_WT("sqstd_register_bloblib"),
		/*explain*/	_WT("注册初始化blob库，注册之前压入一个表，用于注册全局库函数，具体哪些函数见文档。成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_注册数学库"),
		/*egname*/	_WT("sqstd_register_mathlib"),
		/*explain*/	_WT("注册初始化数学库，注册之前压入一个表，用于注册全局库函数，具体哪些函数见文档。成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_正则编译"),
		/*egname*/	_WT("sqstd_rex_compile"),
		/*explain*/	_WT("编译一个正则表达式文本，成功返回正则表达式句柄。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_rex_compile) / sizeof(s_arg_sqstd_rex_compile[0]),
		/*arg lp*/	s_arg_sqstd_rex_compile,
	},
	{
		/*ccname*/	_WT("松鼠库_正则释放"),
		/*egname*/	_WT("sqstd_rex_free"),
		/*explain*/	_WT("释放编译的正则表达式句柄。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		_SDT_NULL,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_rex) / sizeof(s_arg_sqstd_rex[0]),
		/*arg lp*/	s_arg_sqstd_rex,
	},
	{
		/*ccname*/	_WT("松鼠库_正则匹配"),
		/*egname*/	_WT("sqstd_rex_match"),
		/*explain*/	_WT("用一个正则表达式来匹配一个文本。如果这个文本符合正则表达式指定的模式，返回真；否则返回假。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_BOOL,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_rex_match) / sizeof(s_arg_sqstd_rex_match[0]),
		/*arg lp*/	s_arg_sqstd_rex_match,
	},
	{
		/*ccname*/	_WT("松鼠库_正则搜索"),
		/*egname*/	_WT("sqstd_rex_search"),
		/*explain*/	_WT("使用指定的正则表达式搜索指定文本中与该表达式匹配的子文本。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_BOOL,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_rex_search) / sizeof(s_arg_sqstd_rex_search[0]),
		/*arg lp*/	s_arg_sqstd_rex_search,
	},
	{
		/*ccname*/	_WT("松鼠库_正则范围搜索"),
		/*egname*/	_WT("sqstd_rex_searchrange"),
		/*explain*/	_WT("使用指定的正则表达式搜索指定文本中与该表达式匹配的子文本。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_BOOL,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_rex_searchrange) / sizeof(s_arg_sqstd_rex_searchrange[0]),
		/*arg lp*/	s_arg_sqstd_rex_searchrange,
	},
	{
		/*ccname*/	_WT("松鼠库_正则取子表达式数"),
		/*egname*/	_WT("sqstd_rex_getsubexpcount"),
		/*explain*/	_WT("返回子表达式数。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
	...
	{
		/*ccname*/	_WT("松鼠库_正则取子表达式"),
		/*egname*/	_WT("sqstd_rex_getsubexp"),
		/*explain*/	_WT("获取子表达式"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_BOOL,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_rex_getsubexp) / sizeof(s_arg_sqstd_rex_getsubexp[0]),
		/*arg lp*/	s_arg_sqstd_rex_getsubexp,
	},
	{
		/*ccname*/	_WT("松鼠库_格式化"),
		/*egname*/	_WT("sqstd_format"),
		/*explain*/	_WT("根据'栈索引'位置的对象和后面的可选参数(如：格式化文本在-2，参数就在-1处)创建一个新的字符串。 格式字符串遵循与标准C函数的printf系列相同的规则（不支持“*”）。"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
		...
		/*bmp inx*/	0,
		/*bmp num*/	0,
		/*ArgCount*/sizeof(s_arg_sqstd_format) / sizeof(s_arg_sqstd_format[0]),
		/*arg lp*/	s_arg_sqstd_format,
	},
	{
		/*ccname*/	_WT("松鼠库_注册文本库"),
		/*egname*/	_WT("sqstd_register_stringlib"),
		/*explain*/	_WT("注册初始化文本库，注册之前压入一个表，用于注册全局库函数，具体哪些函数见文档。成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
	...
	{
		/*ccname*/	_WT("松鼠库_注册系统库"),
		/*egname*/	_WT("sqstd_register_systemlib"),
		/*explain*/	_WT("注册初始化系统库，注册之前压入一个表，用于注册全局库函数，具体哪些函数见文档。成功返回>=0"),
		/*category*/11,
		/*state*/	0,
		/*ret*/		SDT_INT,
		/*reserved*/0,
...
EXTERN_C void esquirrel3_fn_sqstd_fopen(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = (INT)sqstd_fopen(pArgInf[0].m_pText, pArgInf[1].m_pText);
}
EXTERN_C void esquirrel3_fn_sqstd_fread(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = sqstd_fread((SQUserPointer)pArgInf[0].m_int, pArgInf[1].m_int, pArgInf[2].m_int, (SQFILE)pArgInf[3].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_fwrite(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = sqstd_fwrite((SQUserPointer)pArgInf[0].m_int, pArgInf[1].m_int, pArgInf[2].m_int, (SQFILE)pArgInf[3].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_fseek(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = sqstd_fseek((SQFILE)pArgInf[0].m_int, pArgInf[1].m_int, pArgInf[2].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_ftell(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = sqstd_ftell((SQFILE)pArgInf[0].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_fflush(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = sqstd_fflush((SQFILE)pArgInf[0].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_fclose(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = sqstd_fclose((SQFILE)pArgInf[0].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_feof(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_bool = sqstd_feof((SQFILE)pArgInf[0].m_int);
}

EXTERN_C void esquirrel3_fn_sqstd_createfile(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_createfile(vm, (SQFILE)pArgInf[1].m_int, pArgInf[2].m_bool);
}
EXTERN_C void esquirrel3_fn_sqstd_getfile(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_getfile(vm, pArgInf[1].m_int, (SQFILE*)pArgInf[2].m_pInt);
}
EXTERN_C void esquirrel3_fn_sqstd_loadfile(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_loadfile(vm, pArgInf[1].m_pText, pArgInf[2].m_bool);
}
EXTERN_C void esquirrel3_fn_sqstd_dofile(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_dofile(vm, pArgInf[1].m_pText, pArgInf[2].m_bool, pArgInf[3].m_bool);
}
EXTERN_C void esquirrel3_fn_sqstd_writeclosuretofile(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_writeclosuretofile(vm, pArgInf[1].m_pText);
}
EXTERN_C void esquirrel3_fn_sqstd_register_iolib(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_register_iolib(vm);
}
EXTERN_C void esquirrel3_fn_sqstd_seterrorhandlers(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	sqstd_seterrorhandlers(vm);
}
EXTERN_C void esquirrel3_fn_sqstd_printcallstack(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
...
EXTERN_C void esquirrel3_fn_sqstd_createblob(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = (INT)sqstd_createblob(vm, pArgInf[1].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_getblob(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_getblob(vm, pArgInf[1].m_int, (SQUserPointer*)pArgInf[2].m_pInt);
}
EXTERN_C void esquirrel3_fn_sqstd_getblobsize(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_getblobsize(vm, pArgInf[1].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_register_bloblib(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_register_bloblib(vm);
}

EXTERN_C void esquirrel3_fn_sqstd_register_mathlib(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_register_mathlib(vm);
}

EXTERN_C void esquirrel3_fn_sqstd_rex_compile(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	const SQChar* errorStr = NULL;
	pRetData->m_int = (INT)sqstd_rex_compile(pArgInf[0].m_pText, &errorStr);
	if(pArgInf[1].m_dtDataType!= _SDT_NULL)
	{
		if(*pArgInf[1].m_ppText)
		{
			MFree(*pArgInf[1].m_ppText);
		}
		*pArgInf[1].m_ppText = CloneTextData((char*)errorStr);
	}
}
EXTERN_C void esquirrel3_fn_sqstd_rex_free(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	sqstd_rex_free((SQRex*)pArgInf[0].m_int);
}
EXTERN_C void esquirrel3_fn_sqstd_rex_match(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_bool = sqstd_rex_match((SQRex*)pArgInf[0].m_int, pArgInf[1].m_pText);
}

EXTERN_C void esquirrel3_fn_sqstd_rex_search(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	const SQChar* pStr = pArgInf[1].m_pText + pArgInf[2].m_int;
	const SQChar* out_begin = NULL;
	const SQChar* out_end = NULL;

	pRetData->m_bool = sqstd_rex_search((SQRex*)pArgInf[0].m_int, pStr, &out_begin, &out_end);
	*pArgInf[3].m_pInt = (INT)(out_begin - pArgInf[1].m_pText);
	*pArgInf[4].m_pInt = (INT)(out_end - out_begin);

}
EXTERN_C void esquirrel3_fn_sqstd_rex_searchrange(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	const SQChar* pStr = pArgInf[1].m_pText + pArgInf[2].m_int;
	const SQChar* pEndStr = pStr + pArgInf[3].m_int;
	const SQChar* out_begin = NULL;
	const SQChar* out_end = NULL;

	pRetData->m_bool = sqstd_rex_searchrange((SQRex*)pArgInf[0].m_int, pStr, pEndStr, &out_begin, &out_end);
	*pArgInf[4].m_pInt = (INT)(out_begin - pArgInf[1].m_pText);
	*pArgInf[5].m_pInt = (INT)(out_end - out_begin);

}
EXTERN_C void esquirrel3_fn_sqstd_rex_getsubexpcount(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	pRetData->m_int = sqstd_rex_getsubexpcount((SQRex*)pArgInf[0].m_int);
}

EXTERN_C void esquirrel3_fn_sqstd_rex_getsubexp(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SQRexMatch rm;
	pRetData->m_bool = sqstd_rex_getsubexp((SQRex*)pArgInf[0].m_int, pArgInf[1].m_int, &rm);
	if (*pArgInf[2].m_ppText)
	{
		MFree(*pArgInf[2].m_ppText);
	}
	*pArgInf[2].m_ppText = CloneTextData((char*)rm.begin, rm.len);
}

EXTERN_C void esquirrel3_fn_sqstd_format(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	SQInteger outlen;
	SQChar* outstr = NULL;

	pRetData->m_int = sqstd_format(vm, pArgInf[1].m_int, &outlen, &outstr);
	if (*pArgInf[2].m_ppText)
	{
		MFree(*pArgInf[2].m_ppText);
	}
	*pArgInf[2].m_ppText = CloneTextData((char*)outstr, outlen);

}

EXTERN_C void esquirrel3_fn_sqstd_register_stringlib(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_register_stringlib(vm);
}

EXTERN_C void esquirrel3_fn_sqstd_register_systemlib(PMDATA_INF pRetData, INT iArgCount, PMDATA_INF pArgInf)
{
	SETUP_VM(pArgInf);
	pRetData->m_int = sqstd_register_systemlib(vm);
}
...
PFN_EXECUTE_CMD s_RunFunc[] =	// 索引应与s_CmdInfo中的命令定义顺序对应
{
	...
	esquirrel3_fn_sqstd_fopen,
	esquirrel3_fn_sqstd_fread,
	esquirrel3_fn_sqstd_fwrite,
	esquirrel3_fn_sqstd_fseek,
	esquirrel3_fn_sqstd_ftell,
	esquirrel3_fn_sqstd_fflush,
	esquirrel3_fn_sqstd_fclose,
	esquirrel3_fn_sqstd_feof,
	esquirrel3_fn_sqstd_createfile,
	esquirrel3_fn_sqstd_getfile,
	esquirrel3_fn_sqstd_loadfile,
	esquirrel3_fn_sqstd_dofile,
	esquirrel3_fn_sqstd_writeclosuretofile,
	esquirrel3_fn_sqstd_register_iolib,
	esquirrel3_fn_sqstd_seterrorhandlers,
	esquirrel3_fn_sqstd_printcallstack,
	esquirrel3_fn_sqstd_createblob,
	esquirrel3_fn_sqstd_getblob,
	esquirrel3_fn_sqstd_getblobsize,
	esquirrel3_fn_sqstd_register_bloblib,
	esquirrel3_fn_sqstd_register_mathlib,
	esquirrel3_fn_sqstd_rex_compile,
	esquirrel3_fn_sqstd_rex_free,
	esquirrel3_fn_sqstd_rex_match,
	esquirrel3_fn_sqstd_rex_search,
	esquirrel3_fn_sqstd_rex_searchrange,
	esquirrel3_fn_sqstd_rex_getsubexpcount,
	esquirrel3_fn_sqstd_rex_getsubexp,
	esquirrel3_fn_sqstd_format,
	esquirrel3_fn_sqstd_register_stringlib,
	esquirrel3_fn_sqstd_register_systemlib
};
